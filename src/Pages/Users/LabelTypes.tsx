...
import { setLabelTypes, setSelectedLabelTypeIds, toggleLabelType } from "../../store/slices/userSlice";
...
const LabelTypeSelector: React.FC = () => {
    ...
    //   const { data: LabelTyepsData, isLoading } = useGetLabelTypesQuery();
    ...
    useEffect(() => {
        dispatch(setLabelTypes(staticLabelTypes));
    }, [dispatch])

    const { labelTypes, selectedLabelTypeIds } = useSelector(
        ...
        <Box display="flex" flexDirection="column" gap={1} sx={{ mb: 2, ml: "2px" }}>
            <Box display="flex" gap={1} alignItems="center">
                <Typography variant="subtitle1">
                   Roles({selectedLabelTypeIds.length})
                </Typography>
                <Tooltip title="Clear">
            ...
            <Box display="flex" gap={1} flexWrap="wrap">
                        ...
                        return (
                            <Tooltip title={label.labelTypeName} key={label.labelTypeId}>
                                <Chip
                                    ...
                                    sx={{
                                        backgroundColor: isSelected ? "#E1ECF4" : "#F4F5F7",
                ...
                >
                    <Box
                        p={2}
                        maxHeight={265}
                        sx={{ overflowY: "auto", marginTop: "2px", padding: "8px" }}
                    >
                        <TextField
                            fullWidth
                            size="small"
