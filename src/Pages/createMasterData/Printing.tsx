...
const Printing: React.FC<PrintingProps> = ({
  ...
  useEffect(() => {
    ...
    for (const field of importantFields) {
      if (
        ["static_charge", "format_correct", "cylinder_teeth"].includes(field)
      ) {
        const value =
          formValues.printingDetails[
            field as keyof typeof formValues.printingDetails
          ];
        ...
        const value =
          formValues.printingSubstrateSettings[
            field as keyof typeof formValues.printingSubstrateSettings
          ];
