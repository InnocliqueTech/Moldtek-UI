...
const Printing: React.FC<PrintingProps> = ({
  ...
  const machineFields = [
    ...
    { id: "unwinder", label: "Unwinder", options: ["4.5","5","2","110", "6"] },
    { id: "infeed", label: "Infeed", options: ["6.5","9","7","110", "5"] },
    { id: "outfeed", label: "Outfeed", options: ["7.5","9.5","8","110","120"] },
    { id: "rewinder", label: "Rewinder", options: ["6","8","7","50%", "7.5"] },
  ...
  const renderField = (field: {
    ...
    return (
      <ReusableInput
        ...
        // helperText={error}
        required={
          field.label === "Static Charge" || field.label === "Format Correct" || field.label === "Tension" || field.label === "Cylinder Teeth"
            ? false
            : true
        }
      />
