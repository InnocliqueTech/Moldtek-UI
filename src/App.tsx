...
const ProductionOperatorsPage = lazy(
  () => import("./Pages/Production_Operators/Production_Operators")
);
const ReportsPage = lazy(() => import("./Pages/Reports/Reports"));
const SettingsPage = lazy(() => import("./Pages/Settings/Settings"));
const MasterData = lazy(() => import("./Pages/Create_Master_Data/MasterData"));
const CreateMasterData = lazy(
  () => import("./Pages/Create_Master_Data/CreateMasterData")
);
...
const NotFoundPage = lazy(
  () => import("./Components/Authentication/NotFoundPage")
);
const ViewMasterData = lazy(
  () => import("./Pages/View_Master_Data/ViewMasterData")
);
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<Layout />}>
              ...
              <Route
                path="/viewDailyPlan/:indentNo"
                element={<ViewDailyPlan />}
              />
